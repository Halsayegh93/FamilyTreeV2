-- v8: تصحيح أسماء الأعمدة الفعلية في كل جدول
--   news_comments: author_id (ليس member_id)
--   member_gallery_photos: created_by (المرفع، أهم من member_id)
--   family_stories: created_by (المرفع، أهم من member_id)
