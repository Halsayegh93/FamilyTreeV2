...
// ⚠️ نسخة مطابقة للملف في التطبيق (Core/SharedSessionStore.swift).
// المشروع يستخدم مجلدات متزامنة، فلا يمكن ضمّ ملف واحد لهدفين — أي تعديل
// هنا يجب أن يُطبَّق هناك أيضاً (وهو ملف صغير ومستقر).
