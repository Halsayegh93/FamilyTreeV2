...
export const BRACKET = [
  // R32 winners -> R16
  [1,'W',17,'home'],[4,'W',17,'away'],
  [3,'W',18,'home'],[6,'W',18,'away'],
  [2,'W',19,'home'],[5,'W',19,'away'],
  [7,'W',20,'home'],[8,'W',20,'away'],
  [12,'W',21,'home'],[11,'W',21,'away'],
  [10,'W',22,'home'],[9,'W',22,'away'],
  [15,'W',23,'home'],[14,'W',23,'away'],
  [13,'W',24,'home'],[16,'W',24,'away'],
  // R16 winners -> QF
...
const R32 = [
  ...
  ['إنجلترا','🏴󠁧󠁢󠁥󠁮󠁧󠁿','اليابان','🇯🇵','Gillette Stadium, Boston','2026-06-29T23:00:00Z'],
...
const LATER = [
  ...
  ['R16', 1, 'NRG Stadium, Houston','2026-07-04T17:00:00Z'],
  ['R16', 2, 'Lincoln Financial Field, Philadelphia','2026-07-04T21:00:00Z'],
  ['R16', 3, 'MetLife Stadium, New York/NJ','2026-07-05T20:00:00Z'],
  ['R16', 4, 'Estadio Azteca, Mexico City','2026-07-06T00:00:00Z'],
  ['R16', 5, 'AT&T Stadium, Dallas','2026-07-06T19:00:00Z'],
  ['R16', 6, 'Lumen Field, Seattle','2026-07-07T00:00:00Z'],
  ['R16', 7, 'Mercedes-Benz Stadium, Atlanta','2026-07-07T16:00:00Z'],
  ['R16', 8, 'BC Place, Vancouver','2026-07-07T20:00:00Z'],
  ['QF', 1, 'Gillette Stadium, Boston','2026-07-09T20:00:00Z'],
  ['QF', 2, 'SoFi Stadium, Los Angeles','2026-07-10T19:00:00Z'],
  ['QF', 3, 'Hard Rock Stadium, Miami','2026-07-11T21:00:00Z'],
  ['QF', 4, 'Arrowhead Stadium, Kansas City','2026-07-12T01:00:00Z'],
  ['SF', 1, 'AT&T Stadium, Dallas','2026-07-14T19:00:00Z'],
  ['SF', 2, 'Mercedes-Benz Stadium, Atlanta','2026-07-15T19:00:00Z'],
...
function seedPredictions() {
  ...
  return [
    p(1, 'حسن', 3, 1), p(2, 'حسن', 2, 1), p(3, 'حسن', 1, 1, 4, 2), p(4, 'حسن', 1, 1, 3, 5), p(5, 'حسن', 2, 0),
    p(1, 'عبدالله', 2, 1), p(2, 'عبدالله', 2, 0), p(3, 'عبدالله', 0, 0, 2, 4), p(4, 'عبدالله', 0, 2),
    p(1, 'فهد', 1, 0), p(2, 'فهد', 3, 1), p(3, 'فهد', 2, 1), p(4, 'فهد', 0, 1), p(5, 'فهد', 1, 1, 5, 4),
    p(1, 'سارة', 3, 1), p(2, 'سارة', 1, 0), p(3, 'سارة', 1, 1, 4, 3), p(4, 'سارة', 0, 2),
  ];
}
